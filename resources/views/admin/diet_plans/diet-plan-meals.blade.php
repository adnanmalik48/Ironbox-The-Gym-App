      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">IRON BOX PLAN MEAL's
            <a href="{{ route('diet_plan_days',request()->session()->get('day_id')) }}" class="btn btn-primary btn-sm float-right"  ><i class="now-ui-icons arrows-1_minimal-left"></i> BACK</a>
          ...
          <div class="table-responsive">
              <table id="datatable" class="table">
                ...
                <th style="font-size:15px;" >Meal</th>
                <th style="font-size:15px;">Time</th>
                <th style="font-size:15px;">Calories </th>
                <th style="font-size:15px;">Porteins </th>
                <th style="font-size:15px;">Fats </th>
                <th style="font-size:15px;">Carbohydrates </th>
                <th style="font-size:15px;"> ACTION</th>
                </thead>
                <tbody>
                @foreach($customDietPlanMeals as $row)
                  ...
                  <td>{{$row->total_calories}} kcal </td>
                    ...
                    <td>{{$row->total_fat}} </td>
                    <td>{{$row->total_carbohydrates}} </td>

                    <td colspan="2">
                    <a href="{{ route('diet_plan_meal_dishes',$row->id) }}"  class="btn btn-primary btn-sm " ><b>See Dishes</b></a>
