...
<div class="row">
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">IRON BOX PLAN REVIEWS 
     
            <a href="{{route('reviewed_plans')}}" class="btn btn-primary btn-sm float-right"  > Back</a>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table id="datatable" class="table">
                ...
                <th style="font-size:15px;" > REVIEWERS </th>
    ...
    @endforeach 
              ...
              <a href="{{ route('plan_review_details',$row->id) }}"> read more</a>
            </td>
                    <td colspan="2">
...
$('#datatable').on('click', '.deletebtn', function(){
  ...
  console.log(data[0]);
  $('#delete_model_form').attr('action', '/plan_reviews/'+data[0]);
