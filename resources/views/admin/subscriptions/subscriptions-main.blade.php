      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">IRON BOX ALL SUBSCRIBERS 
        <a href="{{route('subscriptions_history.index')}}" class="btn btn-primary btn-sm float-right"  ><i class="fas fa-history"></i></i> User History</a>
            </h4>
...
<!--                  
  ...
  @if($row->status ==0)         
                        <td >  
                        <form action="/subscriptions/{{$row->id}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
    ...
    <button type="submit" class="btn btn-sm btn-success">Active</button>      
                    ...
                    <!-- <td colspan="2"> -->
                    <!-- <a href="{{ route('subscriptions.show',$row->id) }}"  class="btn btn-primary btn-sm " >View Details</a> -->
