...
<div class="row">
      <div class="col-md-12">
      <div id="main-notice">   <p style="color:black; font-size:15px; background-color:yellow; padding:20px; border-radius:4px;"><b><i class="fas fa-exclamation-triangle" style="color:red;  font-size:30px;"></i> Please be careful on delete operation on users it may change overall application behaviour.</b>  <a type="button" style="text-decoration:none; font-size:18px; margin-left:20px; color:black;" id="toggle"><b>X</b></a></p></div>
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">IRON BOX REGISTERED USER's 
        <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right"  ><i class="fas fa-plus"></i> Add</a>
            </h4>
            ...
            <div class="table-responsive">
              <table id="datatable" class="table">
                ...
                @foreach($users as $row)
                  ...
                  <!-- <b style="font-size:17px; color:#72aee6;"><i class="fas fa-star"></i> {{Str::limit($rating->avg_rating, 4)}}</b> -->
    ...
    @endforeach 
                    ...
                    <!-- @if($row->accountStatus ==0)         
                        ...
                        <a href="javascript:void(0)"  style="font-weight:900;color:orange;" class=" updatebtn" >Pending</a> 
                  ...
                  <td>  
                    ...
                    <a href="javascript:void(0)" style="font-weight:900;color:green;" class=" updatebtn" >Approved</a> 
    ...
    <button type="submit" class="btn btn-sm btn-success">Active</button>      
        ...
        <div class="dropdown-menu dropdown-setting" >
            <a href="{{ route('users.show',$row->id) }}" class="dropdown-item"><i class="fas fa-binoculars" style="color:black;"></i>See Details</a>
            <a href="{{ route('users.edit',$row->id) }}" class="dropdown-item"><i class="fas fa-pencil-alt" style="color:black;"></i>Edit</a>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    ...
    <!-- <option  id="current_status" ></td>    -->
<!-- @if($row->status ==0)         
<option hidden value="0">Pending</td>         
@else
<option hidden value="1">  Approved </td>        
@endif -->
