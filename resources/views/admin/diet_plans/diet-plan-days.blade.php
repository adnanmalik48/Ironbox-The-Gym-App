      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">IRON BOX PLAN Day's
          ...
          <div class="table-responsive">
              <table id="datatable" class="table">
                ...
                <th style="font-size:15px;">Meals </th>
                ...
                <th style="font-size:15px;">Day </th>
                <th style="font-size:15px;"> Week</th>
                <th style="font-size:15px;"> ACTION</th>
                </thead>
                <tbody>
                @foreach($customDietPlanDay as $row)

                  <tr>
                  <td>{{$row->id}}</td>
                  <td>{{$row->total_meals}} meals</td>
                  ...
                  <td>{{$row->total_calories}} kcal </td>
                    ...
                    <td colspan="2">
                    <a href="{{ route('diet_plan_meals',$row->id) }}"  class="btn btn-primary btn-sm " ><b>See Meals</b></a>
