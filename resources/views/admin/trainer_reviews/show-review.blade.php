...
<div class="row">
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">IRON BOX TRAINER REVIEWS 
     
            <a href="{{route('reviewed_trainers')}}" class="btn btn-primary btn-sm float-right"  > Back</a>
    ...
    @endforeach 
              ...
              <a href="{{ route('trainer_review_detail',$row->id) }}"> read more</a>
            </td>
                    <td colspan="2">
